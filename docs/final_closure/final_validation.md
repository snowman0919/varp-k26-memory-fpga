...
검증 기준: `v11-conference-final` 공개 기준선은 불변으로 보존하고, 16장 발표 개정은 `conference-final` 최신 커밋에서 검증
...
| `make presentation` | PASS — 16장, 내장 영상 4개, notes 16개, 목표 590초·낭독 추정 578.0초, 최소 12 pt |
| 본선 심사 기준 Gate | PASS — 주제 이해도·전달성·질의응답·참여도 매핑, 슬라이드별 그림 순서·예상 질문·답변·주의 표현 16개 |
...
`v11-conference-final`은 공개 당시의 불변 기준선이다. 이후 요청된 16장 발표 개정은
