...
두 문서가 충돌하면 더 최근의 v11 명칭과 사용자 승인 17장 발표 구성을 적용한다. 사실성,
...
| 발표 | 사용자 승인 17장, 9:20~9:50, 목차와 진행 표시 | **PASS** | 17장, 목표 575초·낭독 추정 572.3초, PPTX/PDF/notes/source index/PNG/contact sheet; 본선 30·10·20·5점 기준 매핑 |
| Manim | 설명 기능이 있는 영상 3개 이상 | **PASS** | 데이터 흐름·작업 재분배·타임라인·꼬리 지연·병목 이동 영상과 정지 fallback 생성 |
| 발표 편집성 | 텍스트·도형·그래프 편집 가능 | **PASS** | 17장 검증, 5개 내장 영상, 텍스트·도형 중심 구성; 전체 슬라이드 이미지화 없음 |
| Q&A | 80개 이상, v11 연구 중심 | **PASS** | 발표자 전용 98문항(20초/60초 답변·근거 위치 포함), 타 발표용 10문항, 기존 89문항 학습 자료 보존 |
...
| GitHub | `conference-final`, 최종 commit/tag/release | **PASS** | 공개 기준선 `fe65fd6`·annotated tag `v11-conference-final`과 자산 17개는 불변 보존; 17장 발표 개정은 `conference-final` 후속 커밋, Draft PR #3 유지 |
...
| 독립 검토 | 최소 5회 | **PASS** | 누적 6회 검토에 더해 기술 발표자·시각 가독성·하드웨어 연구자 3개 역할의 최종 독립 검토와 재검토 기록 보존 |
...
5. 연구 동결 이후 v11 논문·17장 발표 생성: 완료.
