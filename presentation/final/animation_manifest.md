...
| 3 | `scheduler_timeline.mp4/.gif` | 동일 작업의 정적 배정·지역성 인식 재분배 비교 | `s1_s3_timeline_events.csv` |
...
`presentation.mp4`와 `presentation.gif`는 위 장면을 연결한 무음 시각 요약이다. 9분 35초 구두 설명은 `speaker_notes.md`를 따른다.
